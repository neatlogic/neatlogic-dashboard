...
CREATE TABLE `dashboard`  (
  ...
  `type` enum('custom','system') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'custom' COMMENT '类型',
...
CREATE TABLE `dashboard_authority`  (
  ...
  INDEX `idx_dashboard_uuid`(`dashboard_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '仪表板权限表';
...
CREATE TABLE `dashboard_default`  (
  ...
  INDEX `idx_uuid_userid_type`(`dashboard_id`, `user_uuid`, `type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '仪表板默认表';
...
CREATE TABLE `dashboard_userdefault`  (
  ...
  UNIQUE INDEX `uk_user_uuid`(`user_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户默认仪表板表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '仪表板访问统计表';
...
CREATE TABLE `dashboard_widget`  (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'porlet名称',
  `refresh_interval` int NOT NULL DEFAULT 1 COMMENT '自动刷新间隔，单位秒，0代表不刷新',
  `description` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `dashboard_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '面板Id',
  `handler` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组件',
  `chart_type` enum('barchart','piechart','stackbarchart','areachart','linechart','columnchart','stackcolumnchart','tablechart','numberchart','donutchart') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '视图模板',
  `condition_config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '条件配置',
  `chart_config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '图表配置',
  `detail_widget_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '明细组件uuid',
  `x` int NULL DEFAULT NULL COMMENT 'x',
  `y` int NULL DEFAULT NULL COMMENT 'y',
  `h` int NULL DEFAULT NULL COMMENT 'h',
  `w` int NULL DEFAULT NULL COMMENT 'w',
  `i` int NULL DEFAULT NULL COMMENT 'i',
  PRIMARY KEY (`uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'dashboard_widget';